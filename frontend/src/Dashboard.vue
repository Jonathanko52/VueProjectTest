<template>
  <div id="dashboard">
    ...
    <b-alert :show="error.length === 0 && !isLogged" variant="warning"
      >Please login in order to be able to vote.</b-alert
    >
    ...
    <div class="main">
      <div class="positive">
        <b-badge
          v-if="userRecords"
          v-show="userRecords.value > 0"
          variant="success"
          class="count"
          >{{ userRecords.value }}</b-badge
        >
        <b-btn
          v-show="!loading && isLogged"
          type="submit"
          variant="success"
